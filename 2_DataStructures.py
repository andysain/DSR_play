...
def sortTup(data,i, rev=True):
      sortDat = sorted(data,reverse= rev, key = lambda x: (x[-1],x[i]))
      print "{:<15} | {:<15} | {:<15} | {:<15}".format("Name","a (AU)","e","Class")
      print "-"*60
      for a,b,c,d in sortDat:
            print "{:<15} | {:<15.4} | {:<15.4} | {:<15}".format(a,b,c,orbit_class[d])

sortTup(Asteroids,1,False)
